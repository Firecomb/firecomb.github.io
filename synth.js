var SVoice = function(context, frequency, amplitude, parameters, effect_node) {
...
SVoice.prototype.triggerAmpEnvelope = function() {
...
SVoice.prototype.triggerFilterEnvelope = function() {
...
Synth.prototype.noteOn = function(midi_note_number, midi_note_velocity) {
	...
	this.voices[midi_note_number] = new SVoice(this.context, frequency, amplitude, this.parameters, this.fx_input);
